...
import { FuelType } from "@/app/library/models/FuelType";
import { getActiveFuelTypes } from "@/app/library/mongoDB/fuelTypeData";
...
export async function GET(): Promise<Response> {
     try {
          ...
          const dbResponse: IDataResponse<FuelType[]> = await getActiveFuelTypes();
          console.log("Search result in /api/vehicle/fuel method GET: ", dbResponse);
          ...
          const unknownError: IDataResponse<FuelType> = {
               status: "error",
               data: null,
